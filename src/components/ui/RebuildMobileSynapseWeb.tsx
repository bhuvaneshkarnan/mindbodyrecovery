...
export const RebuildMobileSynapseWeb: React.FC<{ className?: string }> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="mob-rebuild-axon-v" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        <filter id="mob-rebuild-glow" x="-30%" y="-30%" width="160%" height="160%">
          <feGaussianBlur stdDeviation="3" result="blur" />
          <feComposite in="SourceGraphic" in2="blur" operator="over" />
        </filter>

        <radialGradient id="mob-rebuild-soma-halo" cx="50%" cy="50%" r="50%">
      ...
      <circle cx="180" cy="95" r="115" fill="url(#mob-rebuild-soma-halo)" />
